...
public class RecentlySeen extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Product> recentProductsList = (ArrayList<Product>) session.getAttribute("recentProducts");
        System.out.println(recentProductsList);

        String productJSON = prodListToJSON(recentProductsList);
